...
def create_tests(copts):
  ...
  native.cc_test(
      name = "asn1_test",
      size = "small",
      srcs = ["src/crypto/asn1/asn1_test.cc"] + test_support_sources_complete,
      copts = copts,
      deps = [":crypto"],
  )
  ...
  native.cc_test(
      name = "chacha_test",
      size = "small",
      srcs = ["src/crypto/chacha/chacha_test.cc"] + test_support_sources_complete,
      copts = copts,
      deps = [":crypto"],
  )
  ...
  native.cc_test(
      ...
      size = "small",
      srcs = ["src/crypto/curve25519/spake25519_test.cc"] + test_support_sources_complete,
      copts = copts,
      deps = [":crypto"],
  )
